...
describe("Circle", () => {
  it("renders correctly", () => {
    ...
    expect(shape.render()).toEqual(
      '<circle cx="150" cy="100" r="80" fill="Green" />' // Expect the SVG to reflect the blue color
    );
  });
});
...
describe("Square", () => {
  it("renders correctly", () => {
    ...
    expect(shape.render()).toEqual(
      '<rect x="50" y="50" width="200" height="200" fill="Blue" />' // Expect the SVG to reflect the green color
    );
  });
});
...
describe("Triangle", () => {
  it("renders correctly", () => {
    ...
    shape.setColor(color);
    expect(shape.render()).toEqual(
      '<polygon points="150,20 250,180 50,180" fill="Pink" />' // Expect the SVG to reflect the yellow color
    );
  });
});
